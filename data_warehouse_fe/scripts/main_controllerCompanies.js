...
const htmlCompaniesRowData = ((
  ...
  return `<tr>
        ...
        <td class="align-middle">
			<button type="button" class="btn btn-lg text-black-50 editCompany" data-id="${companyID}" data-toggle="modal" data-target="#editCompanyModal"><i class="fa fa-pencil" aria-hidden="true"></i></button>		
            <button type="button" class="btn btn-lg text-black-50 ml-n3 deleteCompany" data-id="${companyID}" data-toggle="modal" data-target="#deleteCompanyModal"><i class="fa fa-trash" aria-hidden="true"></i></button>
